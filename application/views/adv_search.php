...
<title>Human Reseources Admin System - Advanced Search</title>
...
<div class="container">
  ...
  <div class="content" >
    <h1>Advanced Search <img src="ssl_icon.png" alt="ssl_icon" name="ssl_icon"  id="ssl_icon" /></h1> 
   
       <form action="/1284183/index.php/login" method="GET">
    <table class="login">
    <tr>
    	<td><label for="eID">Employee ID:</label></td>
        <td><input type="text"  id="eID" name="eID" tabindex="0" > </td>	
    </tr>    
    <tr>
    ...
    <tr>
    	<td><label for="salary">Salary from:</label></td>
        <td width="360px"><input type="text"  id="salaryF" name="salaryF" tabindex="1" width="30px" > to<input type="text"  id="salaryT" name="salaryT" tabindex="1" width="60px"> </td>	
    </tr>   
    <tr>    
    	<td></td>
